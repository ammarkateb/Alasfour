  ...
  Widget _buildNotificationsList(NotificationsController controller) {
    return Column(
      children: [
        ...
        // Notification cards
        _buildNotificationCards(controller),
      ],
    );
  }

  Widget _buildNotificationCards(NotificationsController controller) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 16),
      child: Column(
        children: controller.notifications.map((notification) => Padding(
          padding: const EdgeInsets.only(bottom: 12),
          child: _buildNotificationCard(notification.title, notification.subtitle, notification.time, notification.svgPath, notification.iconBg),
        )).toList(),
      ),
    );
  }
